; ==================================================================
; ThushOS -- An Operating System kernel written in Assembly
; by Adhithya Jayawardhane. This OS is inspired by MikeOS. Great thanks
...
welcome_string      db 'Welcome to ThushOS by Adhithya!', 0
prompt_string       db 'ThushOS :) >> ', 0
